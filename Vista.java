...
class Vista {
	...
	// Menu inicial en donde se registrara un usuario para poder utilizar el
	// programa.
	public int menu() {
	...
	public boolean login() {
		...
		if (uu != null) {
			...
			// Esto es para comprobar que los usuarios y las contraseñas existen y estan
			// guardados.
			...
			// Aqui comprobaremos si la contraseña que estamos ingresando pertenece al
			// usuario
	...
	// creamos cada uno de los usuarios y lo mandamos a listas para guardarlo en el
	// txt
	public void crear() {

		// ArrayList para almacenar objetos de tipo usuario extraídos de la base de
		// datos
	...
	// Imprimir los usuarios con sus contraseñas por si una persona no se acuerda de
	// estos.
	...
	// Le pedira el numero al usuario para saber sus datos al momento de calcular el
	// CO2.s
